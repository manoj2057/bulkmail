...
<div class="col-lg-6">
    ...
    <button type="button" class="btn btn-primary"><a href="{{route('index')}}" style="color:white">View update</a></button>
        ...
        <div class="card-body card-block">
            ...
            <form action="{{ route('updateCategory',$category->id) }}" method="post" enctype="multipart/form-data" class="form-horizontal">
                @csrf
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9"><input type="text" id="text-input" name="category_name" value="{{$category->category_name}}" placeholder="Text" class="form-control"><small class="form-text text-muted">Please enter category name</small></div>
                </div>
                <div class="row form-group">
                    <div class="col col-md-3"><label class=" form-control-label">Status</label>
                    </div>
                    <div class="col-md-6 col-sm-6 ">
                        <input type="checkbox" name="status" checked data-toggle="toggle" data-size="xs" value="1" @if($category->status == 1) checked @endif checked>
                         <label>Active</label>
                    </div>
                </div>
