...
<div class="col-lg-6">
    <div class="card">
        ...
        <div class="card-body card-block">
            ...
            <form action="{{route('storeCourse')}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                @csrf
            
                </div>
                <div class="row form-group">
                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Course name</label></div>
                    <div class="col-12 col-md-9"><input type="text" id="text-input" name="course_name" placeholder="Text" class="form-control"><small class="form-text text-muted">Please enter student name</small></div>
                </div>
                <div class="row form-group">
