...
<div class="col-lg-6">
    <div class="card">
        ...
        <div class="card-body card-block">
            ...
            <form action="{{route('storeStudent')}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                @csrf
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <select name="course_id" id="category_id" class="form-control-sm form-control">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9"><input type="text" id="name" name="student_name" placeholder="Enter student name" class="form-control"></div>
                </div>
                <div class="row form-group">
                    <div class="col col-md-3"><label for="email" class=" form-control-label"> Email<span class="text-danger">*</label></div>
                    <div class="col-12 col-md-9"><input type="email" id="name" name="email" placeholder="Enter your Email " class="form-control"></div>
                </div>
                <div class="row form-group">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9"><input type="date" id="dob" name="dob" placeholder="Enter dob" class="form-control"></div>
                </div>
                <div class="row form-group">
